...
var jwt_js_1 = require("./middlewares/jwt.js");
...
var authMiddleware = function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        if (request.headers.authorization || request.query.authorization) {
            ...
            next();
            jsonwebtoken_1.default.verify("".concat(bearer === null || bearer === void 0 ? void 0 : bearer.slice(bearer.lastIndexOf(' '), bearer.length)), secret, function (error, decoded) {
                if (error) {
                    console.error(error);
...
app.use('/api/login', jwt_js_1.generateToken);
app.use('/api/videos', exports.authMiddleware, index_js_1.router);
